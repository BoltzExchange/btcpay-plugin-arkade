...
using BTCPayServer.Plugins.Boltz.Arkade.Notifications;
...
namespace BTCPayServer.Plugins.Boltz.Arkade;
...
public class ArkadePlugin : BaseBTCPayServerPlugin
{
    ...
    private static void RegisterPluginServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<IWalletLogStore>(sp =>
        {
            ...
            var logDir = Path.Combine(dataDir, "Plugins", "Boltz.Arkade", "wallet-logs");
